...
environment.systemPackages = with pkgs; [
  ...
  vim neovim vscode zed-editor jetbrains.rider neovide

  # Programming languages and tools
  go lua python3 clang zig rustup dotnet-sdk_8
  ...
  telegram-desktop zoom-us vesktop discord
